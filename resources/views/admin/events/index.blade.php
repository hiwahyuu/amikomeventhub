...
@section('page-title', 'Kelola Event - Admin')
                            ...
                            <td class="px-8 py-6 text-center">
                                ...
                                <div class="flex items-center justify-center gap-1.5 mt-1">
                                    <div class="w-16 bg-slate-100 rounded-full h-1">
                                        <div class="bg-indigo-400 h-1 rounded-full" style="width: {{ ($event->sold / $event->capacity) * 100 }}%"></div>
                                    </div>
                            ...
                            <td colspan="5" class="px-8 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    <div class="p-4 bg-slate-50 rounded-full mb-4 text-slate-300">
                                        <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                                    </div>
                                    <p class="text-slate-400 font-bold">Belum ada data event di database.</p>
                                    <a href="{{ route('events.create') }}" class="text-indigo-600 text-sm font-bold mt-1 hover:underline">Tambah satu sekarang →</a>
                                </div>
                            </td>
                        </tr>
                        @endforelse
